...
export const PayLaterAccount = objectType({
  name: 'PayLaterAccount',
  definition(t) {
    t.nonNull.string('id', {
...
export const PayLaterTransaction = objectType({
  ...
  definition(t) {
    ...
    t.nonNull.string('payLaterAccountId', {
...
export const PayLaterTransactionSubscriptionType = objectType({
  name: 'PayLaterTransactionSubscriptionType',
  definition(t) {
    t.nonNull.field('mutationType', {
      type: 'typeOfMutationType',
      description: 'The type of mutationType. Either `ADD` `EDIT` or `DELETE`',
    });
    t.nonNull.field('transaction', { type: 'PayLaterTransaction' });
  },
});
